 ...
 *         description: Unauthorized
 */
router.put("/:id", diaryController_1.replaceDiary);
 ...
 *         description: Unauthorized
 */
router.post("/:diaryId/meals/:meal", diaryController_1.addFoodToMeal);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.delete("/:diaryId/meals/:meal/foods/:foodId", diaryController_1.removeFoodFromMeal);
router.put("/:diaryId/meals/:meal/foods/:foodId", diaryController_1.updateFoodInMeal);
/**
 * @swagger
 ...
 */
router.post("/:diaryId/exercises", diaryController_1.addExercise);
/**
 * @swagger
 ...
 */
router.delete("/:diaryId/exercises/:exerciseId", diaryController_1.removeExercise);
